...
Route::middleware(['auth', 'admin_staff'])->group(function(){
    ...
    Route::get('/single-application', [PageController::class, 'singleApplication'])->name( 'single-application');
    ...
    Route::get('/sidebar', [PageController::class, 'sidebar'])->name('sidebar');
});
